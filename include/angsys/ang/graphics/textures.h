...
#elif !defined __ANGRAPH_TEXTURES_H__
#define __ANGRAPH_TEXTURES_H__
	...
	namespace graphics
	{
		...
		{		
			...
			ANG_BEGIN_INTERFACE(LINK, itexture)
				...
				visible vcall foundation::size<float> tex_dimentions()const pure;
			ANG_END_INTERFACE();
			...
			ANG_BEGIN_INTERFACE(LINK, itexture_loader)
				...
				visible vcall core::async::iasync_t<itexture_loader_t> load_library_async(xml::xml_node_t) pure;
				visible vcall itexture_t load_texture(string) pure;
				visible vcall itexture_t load_texture(xml::xml_node_t) pure;
				visible vcall core::async::iasync_t<itexture_t> load_texture_async(string) pure;
				visible vcall core::async::iasync_t<itexture_t> load_texture_async(xml::xml_node_t) pure;
...
template<> inline ang::graphics::textures::tex_type_t ang::xml::xml_value::as<ang::graphics::textures::tex_type_t>()const { return ang::graphics::textures::tex_type_t::parse(as<cwstr_t>()); }
