...
#elif !defined __ANGRAPH_EFFECTS_H__
#define __ANGRAPH_EFFECTS_H__
	...
	namespace graphics
	{
		namespace effects
		{
			...
			ANG_BEGIN_INTERFACE(LINK, ishaders)
				...
				visible vcall static_array<reflect::attribute_desc> input_layout()const pure;
				visible vcall static_array<reflect::variable_desc> vs_uniforms_layouts()const pure;
				visible vcall static_array<reflect::variable_desc> ps_uniforms_layouts()const pure;
			...
			ANG_BEGIN_INTERFACE(LINK, ieffect_library)
				visible vcall bool load_sources(xml::xml_node_t) pure;
				visible vcall void set_file_system(core::files::ifile_system_t) pure;
				visible vcall bool load_library(xml::xml_node_t) pure;
				visible vcall core::async::iasync_t<ieffect_library_t> load_library_async(xml::xml_node_t) pure;
				visible vcall ieffect_t load_effect(xml::xml_node_t) pure;
				visible vcall core::async::iasync_t<ieffect_t> load_effect_async(xml::xml_node_t) pure;	
				visible vcall ishaders_t load_technique(xml::xml_node_t) pure;
				visible vcall core::async::iasync_t<ishaders_t> load_technique_async(xml::xml_node_t) pure;
