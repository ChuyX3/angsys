...
#include <ang/platform/input.hpp>
...
ANG_REGISTER_RUNTIME_VALUE_TYPE_INFORMATION(ang::platform::events::core_msg_enum_t);
ANG_REGISTER_RUNTIME_VALUE_TYPE_INFORMATION(ang::platform::activate_status_t);

ANG_REGISTER_RUNTIME_VALUE_TYPE_INFORMATION(ang::platform::display::display_info_t);
ANG_REGISTER_RUNTIME_VALUE_TYPE_INFORMATION(ang::platform::display::orientation_t);

ANG_REGISTER_RUNTIME_VALUE_TYPE_INFORMATION(ang::platform::input::poiner_info_t);
ANG_REGISTER_RUNTIME_VALUE_TYPE_INFORMATION(ang::platform::input::key_modifiers_t);
ANG_REGISTER_RUNTIME_VALUE_TYPE_INFORMATION(ang::platform::input::text_selection_t);
ANG_REGISTER_RUNTIME_VALUE_TYPE_INFORMATION(ang::platform::input::keyboard_type_t);
ANG_REGISTER_RUNTIME_VALUE_TYPE_INFORMATION(ang::platform::input::pointer_hardware_type_t);
