	...
	namespace graphics
	{
		namespace d3d11
		{
			...
			public: //overrides
				...
				foundation::size<float> tex_dimentions()const override;
			...
			private:
				...
				collections::map<string, d3d11_texture_t> _textures;
			public:
			...
			public: //overrides
				...
				core::async::iasync_t<textures::itexture_loader_t> load_library_async(xml::xml_node_t) override;
				textures::itexture_t load_texture(string) override;
				textures::itexture_t load_texture(xml::xml_node_t) override;
				core::async::iasync_t<textures::itexture_t> load_texture_async(string) override;
				core::async::iasync_t<textures::itexture_t> load_texture_async(xml::xml_node_t) override;
