	...
	namespace platform
	{
		namespace android
		{
			...
			private:
				...
				foundation::size<float> _client_area;
			...
			private:
				...
				void client_area(foundation::size<float>);
				void scale_factor(foundation::size<float>);
			...
			private:
				...
				core::async::dispatcher_thread_t _worker_thread;
			...
			public: //Methods
				virtual core::async::iasync_task* run_async(ANativeActivity* activity);
				virtual core::async::iasync_task* update_activity(ANativeActivity* activity);
				virtual core::async::iasync_task* stop_async();
