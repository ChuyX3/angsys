...
private:
	...
	uint hash_index(K const& key)const;
	ang_hash_node<K, T>* find(K const& key)const;
};

uint ang_create_hash_index(int, uint);
uint ang_create_hash_index(uint, uint);
uint ang_create_hash_index(long, uint);
uint ang_create_hash_index(ulong, uint);
uint ang_create_hash_index(long64, uint);
uint ang_create_hash_index(ulong64, uint);
uint ang_create_hash_index(pointer, uint);
