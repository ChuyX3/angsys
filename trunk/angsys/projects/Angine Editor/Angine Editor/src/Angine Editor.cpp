...
// Angine Editor.cpp : Defines the class behaviors for the application.
//
...
CAngineEditorApp::CAngineEditorApp()
{
	...
	SetAppID(_T("Angine Editor.AppID.NoVersion"));
...
BOOL CAngineEditorApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_AEProjectTYPE,
		RUNTIME_CLASS(CProjectDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CProjectPropertiesView));
	if (!pDocTemplate)
		return FALSE;
