...
namespace ang
{
	namespace graphics
	{
		namespace scenes
		{
			...
			private:
				collections::vector<model_element> m_elements;
			...
			public:
				...
				core::async::iasync<collections::vector<model_element>> load_async(core::files::input_text_file_t);
				core::async::iasync<collections::vector<model_element>> load_async(core::files::input_binary_file_t);
			...
			public:
				...
				collections::vector<model_element> load(dom::xml::xml_node_t);
				core::async::iasync<collections::vector<model_element>> load_async(dom::xml::xml_node_t);

			private:
				bool load_element(dom::xml::xml_node_t, indexed_model::model_element& out);
				bool load_material(dom::xml::xml_node_t, indexed_model::model_element& out);
				bool load_index_buffer(dom::xml::xml_node_t, indexed_model::model_element& out);
				bool load_vertex_buffer(dom::xml::xml_node_t, indexed_model::model_element& out);
...
ANG_REGIST_RUNTIME_VALUE_TYPE_INFO_INLINE(ang::graphics::scenes::ordered_model::vertex);
ANG_REGIST_RUNTIME_VALUE_TYPE_INFO_INLINE(ang::graphics::scenes::ordered_model::material);
ANG_REGIST_RUNTIME_VALUE_TYPE_INFO_INLINE(ang::graphics::scenes::ordered_model::model_element);
ANG_REGIST_RUNTIME_VALUE_TYPE_INFO_INLINE(ang::graphics::scenes::indexed_model::model_element);