...
namespace ang
{
	namespace graphics
	{
		namespace d3d9
		{
			class d3d9_effect_library;
			class d3d9_effect;
			class d3d9_shaders;

			typedef object_wrapper<d3d9_shaders> d3d9_shaders_t;
			typedef object_wrapper<d3d9_effect> d3d9_effect_t;
			typedef object_wrapper<d3d9_effect_library> d3d9_effect_library_t;
			...
			public:
			//	bool load(d3d9_effect_library_t, xml::ixml_node_t);
				bool use_shaders(d3d9_driver_t);

			public: //overrides
				string resource_name()const override;
				array_view<reflect::attribute_desc> input_layout()const override;
				array_view<reflect::variable_desc> vs_uniforms_layouts()const override;
				array_view<reflect::variable_desc> ps_uniforms_layouts()const override;
			...
			private:
			//	bool load_vertex_shader(d3d9_effect_library_t, xml::ixml_node_t);
			//	bool load_pixel_shader(d3d9_effect_library_t, xml::ixml_node_t);
			//	bool load_vs_const_buffer(d3d9_effect_library_t, xml::ixml_node_t);
			//	bool load_ps_const_buffer(d3d9_effect_library_t, xml::ixml_node_t);
			//	bool load_ps_samplers(d3d9_effect_library_t, xml::ixml_node_t);
			...
			//	collections::unordered_map<string, d3d9_shaders_t> _shaders;
			//	collections::unordered_map<string, d3d9_effect_t> _effects;

			public:
				d3d9_effect_library(d3d9_driver_t parent);
...
//ANG_REGIST_RUNTIME_VALUE_TYPE_INFO(D3D_SHADER_MACRO);
//ANG_REGIST_RUNTIME_VALUE_TYPE_INFO(D3D11_INPUT_ELEMENT_DESC);
