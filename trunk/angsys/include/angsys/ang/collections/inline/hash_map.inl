...
template<typename K, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::iterator<ang::collections::pair<K, T>> ang::collections::hash_map_object<K, T, allocator, hash_index_maker>::insert(K key, T value)
{
...
template<typename K, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::iterator<ang::collections::pair<K, T>> ang::collections::hash_map_object<K, T, allocator, hash_index_maker>::insert(ang::collections::pair<K, T> pair)
{
	if (m_count > (m_table.size() * 0.75))
		increase_capacity();
...
template<typename K, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::iterator<ang::collections::pair<K, T>> ang::collections::hash_map_object<K, T, allocator, hash_index_maker>::update(K key, T value)
{
	if (m_count > (m_table.size() * 0.75))
		increase_capacity();
...
template<typename K, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::iterator<ang::collections::pair<K, T>> ang::collections::hash_map_object<K, T, allocator, hash_index_maker>::update(ang::collections::pair<K, T> pair)
{
	if (m_count > (m_table.size() * 0.75))
		increase_capacity();
...
ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::hash_map_object()
	: m_count(0)
	, m_table()
{
	m_table.allocate(13);
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::hash_map_object(ang::initializer_list<ang::collections::pair<ang::text::basic_string<E, A>, T>> list)
	: hash_map_object()
{
	for (auto it = list.begin(); it < list.end(); ++it)
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::hash_map_object(const ang::nullptr_t&)
	: hash_map_object()
{
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::hash_map_object(hash_map_object&& other)
	: hash_map_object()
{
	m_count = other.m_count;
	m_table.move(other.m_table);
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::hash_map_object(const hash_map_object& other)
	: hash_map_object()
{
	extend(&other);
}
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::hash_map_object(ang::collections::ienum<ang::collections::pair<ang::text::basic_string<E,A>, T>> const* other)
	: hash_map_object()
{
	extend(other);
}
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline const ang::rtti_t& ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::runtime_info()const
{
	return class_info();
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline bool ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::query_interface(const ang::rtti_t& id, ang::unknown_ptr_t out)
{
	if (id.type_id() == class_info().type_id())
	{
		if (out == null) return false;
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline bool ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::is_empty()const {
	return m_count == 0;
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline void ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::clear() {
	if (!m_table.is_empty())
	{
		for (wsize i = 0; i < m_table.size() && m_count > 0; ++i)
		{
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline void ang::collections::hash_map_object<ang::text::basic_string<E, A>, T, allocator, hash_index_maker>::empty() {
	if (!m_table.is_empty())
	{
		for (wsize i = 0; i < m_table.size() && m_count > 0; ++i)
		{
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline bool ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::move(hash_map_object& other)
{
	if (this == &other)
		return false;
	clear();
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
void ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::increase_capacity()
{
	auto new_size = algorithms::hash_table_get_next_size(m_table.size());
	node_array_t new_data;
	new_data.allocate(new_size);
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::pair<ang::text::basic_string<E,A>, T>& ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::at(const ang::collections::base_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>>& it)
{
#ifdef DEBUG_SAFE_CODE
	if (is_empty())
		throw_exception(except_code::invalid_memory);
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::forward_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>> ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::begin()
{
	for (auto i = 0U; i < m_table.size(); ++i)
	{
		if (m_table[i] != null)
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::forward_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>> ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::end()
{
	return iterator_t(const_cast<hash_map_object*>(this), null, 0);
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::const_forward_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>> ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::begin()const
{
	for (auto i = 0U; i < m_table.size(); ++i)
	{
		if (m_table[i] != null)
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::forward_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>> ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::last()
{
	for (int i = (int)m_table.size() - 1; i >= 0; --i)
	{
		if (m_table[i] != null)
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::const_forward_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>> ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::last()const
{
	for (int i = (int)m_table.size() - 1; i >= 0; --i)
	{
		if (m_table[i] != null)
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::const_forward_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>> ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::end()const
{
	return iterator_t(const_cast<hash_map_object*>(this), null, 0);
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::backward_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>> ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::rbegin()
{
	for (int i = (int)m_table.size() - 1; i >= 0; --i)
	{
		if (m_table[i] != null)
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::backward_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>> ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::rend()
{
	return iterator_t(const_cast<hash_map_object*>(this), null, 0);
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::const_backward_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>> ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::rbegin()const
{
	for (int i = (int)m_table.size() - 1; i >= 0; --i)
	{
		if (m_table[i] != null)
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::const_backward_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>> ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::rend()const
{
	return iterator_t(const_cast<hash_map_object*>(this), null, 0);
}
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline bool ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::increase(ang::collections::base_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>>& it)const
{
#ifdef DEBUG_SAFE_CODE
	if (it.parent() != this || it.current() == null)
		throw_exception(except_code::invalid_param);
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline bool ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::increase(ang::collections::base_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>>& it, int offset)const
{
#ifdef DEBUG_SAFE_CODE
	if (it.parent() != this || it.current() == null)
		throw_exception(except_code::invalid_param);
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline bool ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::decrease(ang::collections::base_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>>& it)const
{
#ifdef DEBUG_SAFE_CODE
	if (it.parent() != this || it.current() == null)
		throw_exception(except_code::invalid_param);
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline bool ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::decrease(ang::collections::base_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>>& it, int offset)const
{
#ifdef DEBUG_SAFE_CODE
	if (it.parent() != this || it.current() == null)
		throw_exception(except_code::invalid_param);
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline wsize ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::counter()const
{
	return m_count;
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline bool ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::copy(ang::collections::ienum<ang::collections::pair<ang::text::basic_string<E,A>, T>>const* items) {
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline void ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::extend(ang::collections::ienum<ang::collections::pair<ang::text::basic_string<E,A>, T>>const* items) {
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::iterator<ang::collections::pair<ang::text::basic_string<E, A>, T>> ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::insert(ang::collections::pair<ang::text::basic_string<E,A>, T> pair)
{
	if (m_count > (m_table.size() * 0.75))
		increase_capacity();
...
inline ang::collections::iterator<ang::collections::pair<ang::text::basic_string<E, A>, T>> ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::update(ang::text::raw_cstr_t key, T value)
{
	...
	if (node == null)
	{
		node = allocate_node<ang::text::basic_string<E,A>, T>(ang::forward<ang::text::basic_string<E, A>>(ang::text::basic_string<E, A>(key)), ang::forward<T>(value));
		if (m_table[idx])
		{
			node->next = m_table[idx];
			m_table[idx]->prev = node;
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline ang::collections::iterator<ang::collections::pair<ang::text::basic_string<E, A>, T>> ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::update(ang::collections::pair<ang::text::basic_string<E,A>, T> pair)
{
	if (m_count > (m_table.size() * 0.75))
		increase_capacity();
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline bool ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::remove(ang::collections::base_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>>)
{
	return false;
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename>class hash_index_maker>
inline bool ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>::remove(ang::collections::base_iterator<ang::collections::pair<ang::text::basic_string<E,A>, T>>, T& value)
{
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::object_wrapper()
	: m_ptr(null)
{
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::object_wrapper(type* ptr)
	: m_ptr(null)
{
	set(ptr ? ptr : new ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>());
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::object_wrapper(ang::initializer_list<pair_type> items)
	: m_ptr(null)
{
	set(new ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>());
	for (pair_type item : items)
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::object_wrapper(const collections::ienum<pair_type>* store)
	: m_ptr(null)
{
	set(new ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>());
	m_ptr->copy(store);
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::object_wrapper(object_wrapper && ptr)
	: m_ptr(null)
{
	if (ptr.is_empty())
	{
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::object_wrapper(object_wrapper const& ptr)
	: m_ptr(null)
{
	set(new ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>());
	m_ptr->copy(ptr.get());
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::object_wrapper(ang::nullptr_t const&)
	: m_ptr(null)
{
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
void ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::reset()
{
	if (m_ptr != null)
		m_ptr->release();
	m_ptr = null;
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
void ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::reset_unsafe()
{
	m_ptr = null;
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
bool ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::is_empty()const
{
	return m_ptr == null;
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>* ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::get(void)const
{
	return m_ptr;
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
void ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::set(type* ptr)
{
	auto temp = m_ptr;
	if (ptr == m_ptr) return;
	m_ptr = ptr;
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>** ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::addres_of(void)
{
	return &m_ptr;
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>** ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::addres_for_init(void)
{
	reset();
	return &m_ptr;
}
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>& ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::operator = (type* ptr)
{
	set(ptr);
	return*this;
}
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>& ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::operator = (const ang::nullptr_t&)
{
	reset();
	return*this;
}
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>& ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::operator = (collections::ienum<pair_type> const* items)
{
	if (is_empty())
		set(new ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>());
	m_ptr->copy(items);
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>& ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::operator = (object_wrapper && ptr)
{
	if (this == &other)
		return *this;
	reset();
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>& ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::operator = (object_wrapper const& ptr)
{
	set(ptr.get());
	return*this;
}
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>& ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::operator += (pair_type item)
{
	if (is_empty())
		set(new ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>());
	m_ptr->push(item);
...
template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper_ptr<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>> ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::operator & (void)
{
	return this;
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker> * ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::operator -> (void)
{
	return get();
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker> const* ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::operator -> (void)const
{
	return get();
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::operator ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker> * (void)
{
	return get();
}

template<ang::text::encoding E, template<typename>class A, typename T, template<typename> class allocator, template<typename> class hash_index_maker>
ang::object_wrapper<ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker>>::operator ang::collections::hash_map_object<ang::text::basic_string<E,A>, T, allocator, hash_index_maker> const* (void)const
{
	return get();
}
