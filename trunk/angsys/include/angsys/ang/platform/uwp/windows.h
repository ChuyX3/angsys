	...
	namespace platform
	{
		namespace windows
		{
			...
			public: //Events
				...
				ang_platform_event(events::imsg_event_args, finalize_event);
				...
				ang_platform_event(events::ikey_event_args, put_char_event);
			...
			public: //properties
				...
				property<const graphics::size<float>, get_scale_factor_property> scale_factor;
			...
			protected: //Internal Event Handlers
				...
				dword on_put_char_event(events::message& m);
			...
			protected:
				...
				collections::hash_map<astring, var> m_settings;
			...
			public: //Events
				ang_platform_event(events::iapp_status_event_args, start_event);
				ang_platform_event(events::iapp_status_event_args, exit_event);

			public: //Custom Implementation
				dword on_start(events::message&);
				dword on_activated(events::message&);
				dword on_exit(events::message&);
