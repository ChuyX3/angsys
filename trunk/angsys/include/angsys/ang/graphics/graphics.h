...
namespace ang
{
	namespace graphics
	{
		...
		{
			array<textures::tex_format_t> color_format;
		...
		template<> inline buffers::iindex_buffer_t ifactory::create_index_buffer(buffers::buffer_usage_t usage, array_view<short> init_data)const {
		...
		template<> inline buffers::iindex_buffer_t ifactory::create_index_buffer(buffers::buffer_usage_t usage, array_view<ushort> init_data)const {
		...
		template<> inline buffers::iindex_buffer_t ifactory::create_index_buffer(buffers::buffer_usage_t usage, array_view<int> init_data)const {
		...
		template<> inline buffers::iindex_buffer_t ifactory::create_index_buffer(buffers::buffer_usage_t usage, array_view<uint> init_data)const {
