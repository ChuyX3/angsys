...
bool d3d11_surface::create(platform::icore_view_t view)
{
	...
	m_view = view;
	view->dispatcher()->notify(new ang::platform::events::display_size_change_event(this, &d3d11_surface::on_display_size_changed_event));
...
collections::ienum_ptr<collections::tuple<scenes::itransform_t, iframe_buffer_t>> d3d11_surface::update()
{
	if (m_need_update)
	{
...
bool d3d11_surface::swap_buffers(bool syncronize)
{
