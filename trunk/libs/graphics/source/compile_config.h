...
#ifndef ANG_GRAPHICS_EXPORTS
#define ANG_GRAPHICS_EXPORTS
...
#define DIRECTX9_SUPPORT	(0)
#define DIRECTX11_SUPPORT	(1)
#define DIRECTX12_SUPPORT	(0)
...
#define DIRECT2D_SUPPORT	(0)
#endif//DIRECTX11_SUPPORT
...
ANG_EXTERN void LINK coffe_debug_output_info(const char* message);
ANG_EXTERN void LINK coffe_debug_output_warning(const char* message);
ANG_EXTERN void LINK coffe_debug_output_error(const char* message);
