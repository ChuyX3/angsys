...
inline DXGI_FORMAT coffe::graphics::d3d11::traslate_format_dx(coffe::graphics::textures::tex_format_t format)
{
	switch (format)
	{
...
inline coffe::graphics::textures::tex_format_t coffe::graphics::d3d11::traslate_format_dx(DXGI_FORMAT format)
{
	switch (format)
	{
...
inline int coffe::graphics::d3d11::pixel_size_by_format_dx(coffe::graphics::textures::tex_format format)
{
	switch (format)
	{
...
inline D3D11_SRV_DIMENSION coffe::graphics::d3d11::traslate_type_dx1(coffe::graphics::textures::tex_type_t type)
{
	switch (type)
	{
...
inline coffe::graphics::textures::tex_type_t coffe::graphics::d3d11::traslate_type_dx1(D3D11_SRV_DIMENSION type)
{
	switch (type)
	{
...
inline D3D11_RESOURCE_DIMENSION coffe::graphics::d3d11::traslate_type_dx2(coffe::graphics::textures::tex_type_t type)
{
	switch (type)
	{
	case textures::tex_type::tex1D:
...
inline coffe::graphics::textures::tex_type_t coffe::graphics::d3d11::traslate_type_dx2(D3D11_RESOURCE_DIMENSION type)
{
	switch (type)
	{
