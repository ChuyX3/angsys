...
bool vulkan_driver::is_inherited_of(type_name_t name)
{
	return name == type_of<vulkan_driver>()
		|| object::is_inherited_of(name)
		|| idriver::is_inherited_of(name);
}
...
buffers::ivertex_buffer_t vulkan_driver::create_vertex_buffer(buffers::buffer_usage_t usage, array_view<reflect::attribute_desc> vertex_desc, wsize vertex_count, array_view<byte> init_data)const
{
	return null;
}

buffers::iindex_buffer_t vulkan_driver::create_index_buffer(buffers::buffer_usage_t usage, reflect::var_type_t index_type, wsize index_count, array_view<byte> init_data)const
{
	return null;
}
