...
#ifndef __ANGSYS_H__
#error Can't include convertible.hpp, please include angsys.h inside
#elif !defined __CONVERTIBLE_HPP__
#define __CONVERTIBLE_HPP__
...
inline ang::object_wrapper<ang::object>::object_wrapper(ang::cstr_t cstr)
	: object_wrapper() {
	set(new strings::string_buffer(cstr));
}

inline ang::object_wrapper<ang::object>::object_wrapper(ang::cwstr_t cstr)
	: object_wrapper() {
	set(new strings::wstring_buffer(cstr));
}
