...
ANG_IMPLEMENT_OBJECT_CLASS_INFO(ang::platform::windows::dispatcher, object, platform::imessage_listener, core::async::idispatcher);
ANG_IMPLEMENT_OBJECT_QUERY_INTERFACE(ang::platform::windows::dispatcher, object, platform::imessage_listener, core::async::idispatcher);
