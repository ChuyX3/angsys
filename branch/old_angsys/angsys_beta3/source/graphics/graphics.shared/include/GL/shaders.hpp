...
namespace ang
{
	namespace graphics
	{
		namespace d3d11
		{
			...
			public:
				bool load(d3d11_effect_library_t, xml::ixml_node_t);
			...
			private:
				bool load_vertex_shader(d3d11_effect_library_t, xml::ixml_node_t);
				bool load_pixel_shader(d3d11_effect_library_t, xml::ixml_node_t);
				bool load_vs_const_buffer(d3d11_effect_library_t, xml::ixml_node_t);
				bool load_ps_const_buffer(d3d11_effect_library_t, xml::ixml_node_t);
				bool load_ps_samplers(d3d11_effect_library_t, xml::ixml_node_t);
