...
//VkSwapchainKHR
ANG_REGISTER_RUNTIME_TYPENAME(VkSurfaceKHR)
ANG_REGISTER_RUNTIME_TYPENAME(VkSwapchainKHR)
ANG_REGISTER_RUNTIME_TYPENAME(VkCommandPool)
ANG_REGISTER_RUNTIME_TYPENAME(VkRenderPass)
ANG_REGISTER_RUNTIME_TYPENAME(VkFramebuffer)
