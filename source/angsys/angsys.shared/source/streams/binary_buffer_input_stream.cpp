...
{
	return (type == type_of<binary_buffer_input_stream>())
		|| object::is_kind_of(type)
		|| (type == type_of<ibinary_input_stream>());
}

bool binary_buffer_input_stream::is_inherited_of(type_name_t type)
{
	return (type == type_of<binary_buffer_input_stream>())
...
bool binary_buffer_input_stream::query_object(type_name_t type, unknown_ptr_t out)
{
	if (out == null)
		return false;
	if (type == type_of<binary_buffer_input_stream>())
	{
		*out = this;
		return true;
	}
	...
	else if (type == type_of<ibinary_input_stream>())
	{
...
//
//
//wsize binary_buffer_input_stream::read(wstring& out)
//{
//	struct
//	{
//		uint encoding;
...
//wsize binary_buffer_output_stream::write(string value)
//{
//	cstr_t cstr = value;
//	auto sz = cstr.size() + 8;
...
//}
//
//wsize binary_buffer_output_stream::write(wstring value)
//{
//	cwstr_t cstr = value;
