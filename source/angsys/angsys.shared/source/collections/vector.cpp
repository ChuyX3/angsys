...
ang::object_wrapper<ang::collections::vector_buffer<object_t>>::object_wrapper()
	: _ptr(null)
{

}

ang::object_wrapper<ang::collections::vector_buffer<object_t>>::object_wrapper(ang::collections::vector_buffer<object_t>* ptr)
	: object_wrapper<ang::collections::vector_buffer<object_t>>()
{
	set(ptr);
}


ang::object_wrapper<ang::collections::vector_buffer<object_t>>::object_wrapper(ang::initializer_list_t<object_t> list)
	: object_wrapper<ang::collections::vector_buffer<object_t>>()
{
	set(new collections::vector_buffer<object_t>(ang::move(list)));
}

ang::object_wrapper<ang::collections::vector_buffer<object_t>>::object_wrapper(const ang::collections::ienum<object_t>* store)
	: object_wrapper<ang::collections::vector_buffer<object_t>>()
{
	set(new collections::vector_buffer<object_t>(store));
}


ang::object_wrapper<ang::collections::vector_buffer<object_t>>::object_wrapper(ang::object_wrapper<ang::collections::vector_buffer<object_t>> && other)
	: object_wrapper<collections::vector_buffer<object_t>>()
{
	collections::vector_buffer<object_t> * temp = other._ptr;
	other._ptr = null;
	_ptr = temp;
}


ang::object_wrapper<ang::collections::vector_buffer<object_t>>::object_wrapper(ang::object_wrapper<ang::collections::vector_buffer<object_t>> const& other)
	: object_wrapper<collections::vector_buffer<object_t>>()
{
	set(other.get());
}

ang::object_wrapper<ang::collections::vector_buffer<object_t>>::object_wrapper(ang::nullptr_t const& other)
	: object_wrapper<collections::vector_buffer<object_t>>() { }
...
void ang::object_wrapper<ang::collections::vector_buffer<object_t>>::clean()
{
	if (_ptr)_ptr->release();
	_ptr = null;
}
...
void ang::object_wrapper<ang::collections::vector_buffer<object_t>>::clean_unsafe()
{
	_ptr = null;
}


bool ang::object_wrapper<ang::collections::vector_buffer<object_t>>::is_empty()const
{
	return _ptr == null;
}


ang::collections::vector_buffer<object_t>* ang::object_wrapper<ang::collections::vector_buffer<object_t>>::get(void)const
{
	return _ptr;
}


void ang::object_wrapper<ang::collections::vector_buffer<object_t>>::set(ang::collections::vector_buffer<object_t>* ptr)
{
	ang::collections::vector_buffer<object_t> * temp = _ptr;
	if (ptr == _ptr) return;
	_ptr = ptr;
	if (_ptr)_ptr->add_ref();
	if (temp)temp->release();
...
ang::collections::vector_buffer<object_t>** ang::object_wrapper<ang::collections::vector_buffer<object_t>>::addres_of(void)
{
	return &_ptr;
}


ang::object_wrapper<ang::collections::vector_buffer<object_t>>& ang::object_wrapper<ang::collections::vector_buffer<object_t>>::operator = (ang::collections::vector_buffer<object_t>* ptr)
{
	set(ptr);
	return*this;
}
...
ang::object_wrapper<ang::collections::vector_buffer<object_t>>& ang::object_wrapper<ang::collections::vector_buffer<object_t>>::operator = (const ang::nullptr_t&)
{
	clean();
	return*this;
}
...
ang::object_wrapper<ang::collections::vector_buffer<object_t>>& ang::object_wrapper<ang::collections::vector_buffer<object_t>>::operator = (ang::collections::ienum<object_t> const* items)
{
	if (_ptr == null)
		set(new collections::vector_buffer<object_t>(items));
	else
		_ptr->copy(items);
	return *this;
}
...
ang::object_wrapper<ang::collections::vector_buffer<object_t>>& ang::object_wrapper<ang::collections::vector_buffer<object_t>>::operator = (ang::object_wrapper<ang::collections::vector_buffer<object_t>> && other)
{
	if (this == &other)
		return *this;
	clean();
...
ang::object_wrapper<ang::collections::vector_buffer<object_t>>& ang::object_wrapper<ang::collections::vector_buffer<object_t>>::operator = (ang::object_wrapper<ang::collections::vector_buffer<object_t>> const& other)
{
	set(other._ptr);
	return*this;
}
...
ang::object_wrapper<ang::collections::vector_buffer<object_t>>& ang::object_wrapper<ang::collections::vector_buffer<object_t>>::operator += (object_t value)
{
	if (is_empty())
		set(new ang::collections::vector_buffer<object_t>());
	get()->append(ang::move(value));
	return*this;
}


ang::object_wrapper_ptr<ang::collections::vector_buffer<object_t>> ang::object_wrapper<ang::collections::vector_buffer<object_t>>::operator & (void)
{
	return this;
}


ang::collections::vector_buffer<object_t> * ang::object_wrapper<ang::collections::vector_buffer<object_t>>::operator -> (void)
{
	return get();
}


ang::collections::vector_buffer<object_t> const* ang::object_wrapper<ang::collections::vector_buffer<object_t>>::operator -> (void)const
{
	return get();
}


ang::object_wrapper<ang::collections::vector_buffer<object_t>>::operator ang::collections::vector_buffer<object_t> * (void)
{
	return get();
}


ang::object_wrapper<ang::collections::vector_buffer<object_t>>::operator ang::collections::vector_buffer<object_t> const* (void)const
{
	return get();
}


object_t const& ang::object_wrapper<ang::collections::vector_buffer<object_t>>::operator[](int idx)const
{
#ifdef DEBUG_SAFE_CODE
	if (is_empty()) throw(exception_t(except_code::invalid_memory));
	if (((uint)idx >= _ptr->size()) || (idx < 0)) throw(exception_t(except_code::array_overflow));
...
object_t & ang::object_wrapper<ang::collections::vector_buffer<object_t>>::operator[](int idx)
{
#ifdef DEBUG_SAFE_CODE
	if (is_empty()) throw(exception_t(except_code::invalid_memory));
	if (((uint)idx >= _ptr->size()) || (idx < 0)) throw(exception_t(except_code::array_overflow));
