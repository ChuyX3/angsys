...
{
	return (type == type_name<floating>())
		|| object::is_kind_of(type)
		|| (type == type_name<value<float>>());
}
...
bool floating::query_object(type_name_t type, unknown_ptr_t out)
{
	...
	else if (type == type_name<value<float>>())
	{
...
{
	return (type == type_name<floating64>())
		|| object::is_kind_of(type)
		|| (type == type_name<value<double>>());
}
...
bool floating64::query_object(type_name_t type, unknown_ptr_t out)
{
	...
	else if (type == type_name<value<double>>())
	{
