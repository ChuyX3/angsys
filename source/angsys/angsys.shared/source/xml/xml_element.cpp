...
xml_element::xml_element(wstring name, xml_collection_t items)
	: xml_node(xml_type_t::element)
{
	xml_name(ang::move(name));
...
bool_t xml_element::xml_has_name()const
{
	return !_xml_name.is_empty();
}

bool_t xml_element::xml_has_value()const
{
	return _xml_content.data_type == xml_type_t::value;
}

bool_t xml_element::xml_has_children()const
{
	return _xml_content.data_type == xml_type_t::element_list;
}

bool_t xml_element::xml_has_attributes()const
{
