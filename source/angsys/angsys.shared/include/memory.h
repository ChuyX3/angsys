...
namespace ang
{
	namespace memory
	{
		...
		public:
			...
			virtual void auto_release()override;
			virtual bool can_delete_from(iallocator*)const override;
			virtual pointer memory_alloc(wsize)override;
			virtual void memory_release(pointer)override;
#ifdef _DEBUG
			virtual pointer memory_alloc(wsize, const char* file, int line)override;
		...
		public:
			...
			virtual pointer memory_alloc(wsize)override;
			virtual void memory_release(pointer)override;
			virtual pointer aligned_memory_alloc(wsize, wsize)override;

#ifdef _DEBUG
			virtual pointer memory_alloc(wsize, const char* file, int line)override;
			virtual pointer aligned_memory_alloc(wsize, wsize, const char* file, int line)override;
#endif
