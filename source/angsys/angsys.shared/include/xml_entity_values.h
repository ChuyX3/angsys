...
namespace ang
{
	namespace xml
	{
		...
		public:
			...
			wsize_t offset()const { return _current.offset(); }
			void offset(wsize_t o) { _current.offset(o); }
			bool_t is_valid()const { return _current.is_valid(); }
		};
