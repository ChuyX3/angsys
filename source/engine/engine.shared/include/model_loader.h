...
ANG_REGISTER_RUNTIME_TYPENAME(ang::graphics::engine::scenes::ordered_model::vertex);
ANG_REGISTER_RUNTIME_TYPENAME(ang::graphics::engine::scenes::ordered_model::material);
ANG_REGISTER_RUNTIME_TYPENAME(ang::graphics::engine::scenes::ordered_model::model_element);
ANG_REGISTER_RUNTIME_TYPENAME(ang::graphics::engine::scenes::indexed_model::model_element);