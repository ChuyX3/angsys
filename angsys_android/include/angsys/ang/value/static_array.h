...
namespace ang
{
	namespace collections
	{
		...
		template<typename T> struct static_array<const T>
		{
		public: /*type definitions*/
		...
		public: /*constructors*/
			static_array() : _value(null), _size(0) {}
			static_array(type val, uint size) : _value(val), _size(size) {}
			static_array(ang::nullptr_t, uint size = 0) : _value(null), _size(0) {}
			static_array(value<T const*> val, uint size) : _value(val.get()), _size(size) {}
			static_array(static_array<T> const& other) : _value(other.get()), _size(other._size) {}
			static_array(static_array const& other) : _value(other._value), _size(other._size) {}
			static_array(static_array && other) : _value(ang::move(other._value)), _size(ang::move(other._size)) {}
			template<wsize N>
			static_array(const T(&ar)[N])
				: _value(ar), _size(N) { }
			~static_array() {}
		...
		public: /*operators*/
			static_array& operator = (type val) { set(ang::move(val), 1); return*this; }
			static_array& operator = (value<T const*> const& val) { set(val.get(), 1); return*this; }
			static_array& operator = (static_array const& val) { set(val._value, val._size); return*this; }
			static_array& operator = (static_array && val) { set(ang::move(val._value), ang::move(val._size)); return*this; }
			template<wsize N> static_array& operator = (const T(&ar)[N]) { set(ar, N); return*this; }
		...
		template<> struct LINK static_array<const char>
		{
		public: /*type definitions*/
		...
		public: /*constructors*/
			...
			static_array(ang::nullptr_t, uint size = 0);
			static_array(cstr_t);
			static_array(static_array<char> const& other);
			static_array(static_array const& other);
			static_array(static_array && other);
			template<wsize N>
			static_array(const char(&ar)[N])
				: _value(ar), _size(N - 1U) { }
			~static_array();
		...
		public: /*operators*/
			static_array& operator = (type val);
			static_array& operator = (value<char const*> const& val);
			static_array& operator = (static_array const& val);
			static_array& operator = (static_array && val);
			template<wsize N> static_array& operator = (const char(&ar)[N]) { set(ar, N - 1U); return*this; }
		...
		template<> struct LINK static_array<const byte>
		{
		public: /*type definitions*/
		...
		public: /*constructors*/
			...
			static_array(ang::nullptr_t, uint size = 0);
			static_array(cstr_t);
			static_array(cmstr_t);
			static_array(static_array<byte> const& val);
			static_array(static_array const& other);
			static_array(static_array && other);
			template<wsize N>
			static_array(const byte(&ar)[N])
				: _value(ar), _size(N - 1U) { }
			~static_array();
		...
		public: /*operators*/
			static_array& operator = (type val);
			static_array& operator = (value<byte const*> const& val);
			static_array& operator = (static_array const& val);
			static_array& operator = (static_array && val);
			template<wsize N> static_array& operator = (const byte(&ar)[N]) { set(ar, N - 1U); return*this; }
		...
		template<> struct LINK static_array<const wchar>
		{
		public: /*type definitions*/
		...
		public: /*constructors*/
			...
			static_array(type val, uint size);
			static_array(ang::nullptr_t, uint size = 0);
			static_array(cwstr_t);
			static_array(static_array<wchar> const& other);
			static_array(static_array const& other);
			static_array(static_array && other);
			template<wsize N>
			static_array(const wchar(&ar)[N])
				: _value(ar), _size(N - 1U) { }
			~static_array();
		...
		public: /*operators*/
			static_array& operator = (type val);
			static_array& operator = (value<wchar const*> const& val);
			static_array& operator = (static_array const& val);
			static_array& operator = (static_array && val);
			template<wsize N> static_array& operator = (const wchar(&ar)[N]) { set(ar, N - 1U); return*this; }
