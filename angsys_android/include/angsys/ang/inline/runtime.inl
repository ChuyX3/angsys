...
namespace ang
{
	namespace runtime
	{
		...
		struct runtime_type_builder<T*>
		{
			typedef T* type;
			static inline type_name_t type_of() {
				static type_name_t out = runtime_data_base::regist_typename(ang::move(""_o + runtime_type_builder<type>::type_of() + "*"_s));
				return out;
			}
		...
		template<typename T>
		struct runtime_type_builder<static_array<T>>
		{
			typedef typename value<T>::type type;
			static inline type_name_t type_of() { return runtime::type_of<type>(); }
			static inline bool is_type_of(type_name_t name) { return runtime::is_type_of<type>(name); }
		...
		struct runtime_type_builder<T(Ts...)>
		{
			typedef T(type)(Ts...);
			static inline type_name_t type_of() {
				static type_name_t name = runtime_data_base::regist_typename(ang::move(""_o + runtime::type_of<T>() + "("_s + runtime::args_list_type_of<Ts...>() + ")"_s));
				return name;
			}
		...
		struct runtime_type_builder<T(O::*)(Ts...)>
		{
			typedef T(O::*type)(Ts...);
			static inline type_name_t type_of() {
				static type_name_t name = runtime_data_base::regist_typename(ang::move(""_o + runtime::type_of<T>() + "("_s + runtime::type_of<O>() + "::*)("_s + runtime::args_list_type_of<Ts...>() + ")"_s));
				return name;
			}
...
#if defined WINDOWS_PLATFORM && defined _WIN32
		template<class T, class... Ts>
		struct runtime_type_builder<T(__stdcall*)(Ts...)>
		{
			typedef T(__stdcall*type)(Ts...);
			static inline type_name_t type_of() {
				static type_name_t name = runtime_data_base::regist_typename(ang::move(""_o + runtime::type_of<T>() + "(stdcall*)("_s + runtime::args_list_type_of<Ts...>() + ")"_s));
				return name;
			}
