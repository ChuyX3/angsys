...
namespace ang
{
	namespace collections
	{
		...
		public:
			...
			base_iterator(ienum<T>* p = null, position_t cur = null, uint offset = 0U);
			~base_iterator();
		...
		public:
			...
			iterator(ienum<T>* p = null, position_t cur = null, uint offset = 0U)
		...
		public:
			...
			forward_iterator(ienum<T>* p = null, position_t cur = null, uint offset = 0U)
		...
		public:
			...
			backward_iterator(ienum<T>* p = null, position_t cur = null, uint offset = 0U)
				: iterator<T>(p, cur, offset) {
			}
